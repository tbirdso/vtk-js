    ...
    if (xrPose) {
      ...
      xrPose.views.forEach((view, index) => {
        ...
        if (model.xrSessionType == XrSessionTypes.HmdVR) {
          ...
          let startX = viewport.x / glLayer.framebufferWidth;
          let startY = viewport.y / glLayer.framebufferHeight;
          let endX = (viewport.x + viewport.width) / glLayer.framebufferWidth;
          let endY = (viewport.y + viewport.height) / glLayer.framebufferHeight;
